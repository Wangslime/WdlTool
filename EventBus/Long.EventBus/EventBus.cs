...
namespace Long.EventBus
{
    ...
    { 
        ...
        public void Subscribe<T>(Action<EventData<T>> action)
        {
            IEventData eventHander = new EventHander<T>(action, null);
            PrivateSubscribe<T>(eventHander);
        }
        ...
        public void SubscribeResult<T>(Func<EventData<T>, object> func)
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="func"></param>
        public void SubscribeAsync<T>(Func<EventData<T>, Task> func)
        {
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="func"></param>
        public void SubscribeResultAsync<T>(Func<EventData<T>, Task<object>> func)
        {
        ...
        public void Publish<T>(string eventName)
        {
        ...
        public void Publish<T>(string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { EventName = eventName, Data = t };
            Publish(eventData);
        }
        //public void Publish<T>(string methodName, string eventName)
        //{
        //    EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName };
        //    Publish(eventData);
        //}
        public void Publish<T>(string methodName, string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName, Data = t };
            Publish(eventData);
        }
        public void Publish<T>(string methodName, string eventName, T t, object sender)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName, Data = t , Sender = sender };
            Publish(eventData);
        }
        public void Publish<T>(string eventName, T t, object sender)
        {
            EventData<T> eventData = new EventData<T>() {EventName = eventName, Data = t, Sender = sender };
            Publish(eventData);
        }

        public void Publish<T>(EventData<T> eventData)
        {
            PrivatePublish(eventData);
        }
        ...
        /// <param name="eventData"></param>
        /// <returns></returns>
        public List<object> PublishResult<T>()
        {
            EventData<T> eventData = new EventData<T>();
            return PublishResult(eventData);
        }
        public List<object> PublishResult<T>(string eventName)
        {
            EventData<T> eventData = new EventData<T>() { EventName = eventName };
            return PublishResult(eventData);
        }
        public List<object> PublishResult<T>(T t)
        {
            EventData<T> eventData = new EventData<T>() { Data = t };
            return PublishResult(eventData);
        }
        public List<object> PublishResult<T>(string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { EventName = eventName, Data = t };
            return PublishResult(eventData);
        }
        //public List<object> PublishResult<T>(string methodName, string eventName)
        //{
        //    EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName };
        //    return PublishResult(eventData);
        //}
        public List<object> PublishResult<T>(string methodName, string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName, Data = t };
            return PublishResult(eventData);
        }
        public List<object> PublishResult<T>(EventData<T> eventData)
        {
            return PrivatePublishResult(eventData);
        }
        ...
        public Task PublishAsync<T>(string eventName)
        {
            EventData<T> eventData = new EventData<T>() { EventName = eventName };
            return PublishAsync(eventData);
        }
        public Task PublishAsync<T>(T t)
        {
            EventData<T> eventData = new EventData<T>() { Data = t };
            return PublishAsync(eventData);
        }
        public Task PublishAsync<T>(string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { EventName = eventName, Data = t };
            return PublishAsync(eventData);
        }
        public Task PublishAsync<T>(string methodName, string eventName)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName };
            return PublishAsync(eventData);
        }
        public Task PublishAsync<T>(string methodName, string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName, Data = t };
            return PublishAsync(eventData);
        }
        public Task PublishAsync<T>(EventData<T> eventData)
        {
            return PrivatePublishAsync(eventData);
        }
        ...
        public Task PublishResultAsync<T>(string eventName)
        {
            EventData<T> eventData = new EventData<T>() { EventName = eventName };
            return PublishResultAsync(eventData);
        }
        public Task PublishResultAsync<T>(T t)
        {
            EventData<T> eventData = new EventData<T>() { Data = t };
            return PublishResultAsync(eventData);
        }
        public Task PublishResultAsync<T>(string methodName, T t)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, Data = t };
            return PublishResultAsync(eventData);
        }
        public Task PublishResultAsync<T>(string methodName, string eventName)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName };
            return PublishResultAsync(eventData);
        }
        public Task PublishResultAsync<T>(string methodName, string eventName, T t)
        {
            EventData<T> eventData = new EventData<T>() { MethodName = methodName, EventName = eventName, Data = t };
            return PublishResultAsync(eventData);
        }
        public Task<List<object>> PublishResultAsync<T>(EventData<T> eventData)
        {
            return PrivatePublishResultAsync(eventData);
        }
        ...
        public void Subscribe(Action<EventData> action)
        {
            if (action != null && action.Method != null && !string.IsNullOrEmpty(action.Method.Name))
            {
                ...
                PrivateSubscribe(action.Method.Name, eventHander);
            }
        }
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="func"></param>
        public void SubscribeAsync(Func<EventData, Task> func)
        {
            if (func != null && func.Method != null && !string.IsNullOrEmpty(func.Method.Name))
            {
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="func"></param>
        public void SubscribeResultAsync(Func<EventData, Task<object>> func)
        {
            if (func != null && func.Method != null && !string.IsNullOrEmpty(func.Method.Name))
            {
        ...
        /// <typeparam name="T"></typeparam>
        /// <param name="eventData"></param>
        public void Publish(string methodName)
        {
            EventData eventData = new EventData() { MethodName = methodName };
            Publish(eventData);
        }
        public void Publish(string methodName, string eventName)
        {
            EventData eventData = new EventData() { EventName = eventName, MethodName = methodName };
            Publish(eventData);
        }
        public void Publish(string methodName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, Data = data };
            Publish(eventData);
        }
        public void Publish(string methodName, string eventName, object data)
        {
        ...
        /// <param name="eventData"></param>
        /// <returns></returns>
        public void PublishResult(string methodName)
        {
            EventData eventData = new EventData() { MethodName = methodName };
            PublishResult(eventData);
        }
        public void PublishResult(string methodName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, Data = data };
            PublishResult(eventData);
        }
        public void PublishResult(string methodName, string eventName)
        {
            EventData eventData = new EventData() { MethodName = methodName, EventName = eventName };
            PublishResult(eventData);
        }
        public void PublishResult(string methodName, string eventName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, EventName = eventName, Data = data };
            PublishResult(eventData);
        }
        public List<object> PublishResult(EventData eventData)
        {
            return PrivatePublishResult(eventData);
        }
        ...
        /// <param name="eventData"></param>
        /// <returns></returns>
        public Task PublishAsync(string methodName)
        {
            EventData eventData = new EventData() { MethodName = methodName };
            return PublishAsync(eventData);
        }
        public Task PublishAsync(string methodName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, Data = data };
            return PublishAsync(eventData);
        }
        public Task PublishAsync(string methodName, string eventName)
        {
            EventData eventData = new EventData() { MethodName = methodName, EventName = eventName };
            return PublishAsync(eventData);
        }
        public Task PublishAsync(string methodName, string eventName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, EventName = eventName, Data = data };
            return PublishAsync(eventData);
        }
        public Task PublishAsync(EventData eventData)
        {
            return PrivatePublishAsync(eventData);
        }
        ...
        /// <param name="eventData"></param>
        /// <returns></returns>
        public Task<List<object>> PublishResultAsync(string methodName)
        {
            EventData eventData = new EventData() { MethodName = methodName };
            return PublishResultAsync(eventData);
        }
        public Task<List<object>> PublishResultAsync(string methodName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, Data = data };
            return PublishResultAsync(eventData);
        }
        public Task<List<object>> PublishResultAsync(string methodName, string eventName)
        {
            EventData eventData = new EventData() { MethodName = methodName, EventName = eventName };
            return PublishResultAsync(eventData);
        }
        public Task<List<object>> PublishResultAsync(string methodName, string eventName, object data)
        {
            EventData eventData = new EventData() { MethodName = methodName, EventName = eventName, Data = data };
            return PublishResultAsync(eventData);
        }
        public Task<List<object>> PublishResultAsync(EventData eventData)
        {
            return PrivatePublishResultAsync(eventData);
        }
        ...
        public void Remove<T>()
        {
            ...
            if (dicEventType.ContainsKey(type))
            {
                dicEventType.TryRemove(type, out _);
            }
        }

        public void Remove<T>(string methodName)
        {
            Type type = typeof(T);
            if (dicEventType.ContainsKey(type))
            {
                if (dicEventType.TryGetValue(type, out var eventDatas))
                {
        ...
        public void Remove(string methodName)
        {
            if (dicEventMethod.ContainsKey(methodName))
            {
                dicEventMethod.TryRemove(methodName, out _);
            }
        }
        #endregion
    }
